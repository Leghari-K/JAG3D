...
namespace org.applied_geodesy.adjustment.network.approximation.bundle.transformation
{
	...
	public class TransformationParameterSet
	{
		...
		private IDictionary<TransformationParameterType, TransformationParameter> transformationParameters = new IDictionary<TransformationParameterType, TransformationParameter>
		{
		...
		public virtual void setParameterValue(TransformationParameterType type, double value)
		{
			this.transformationParameters[type].Value = value;
		}

		public virtual double getParameterValue(TransformationParameterType type)
		{
			return this.transformationParameters[type].Value;
		}

		public virtual TransformationParameter get(TransformationParameterType type)
		{
			return this.transformationParameters[type];
		}
	}
