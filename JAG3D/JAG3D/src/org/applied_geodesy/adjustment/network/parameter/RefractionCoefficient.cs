...
namespace org.applied_geodesy.adjustment.network.parameter
{
	...
	public class RefractionCoefficient : AdditionalUnknownParameter
	{

		public RefractionCoefficient() : base(0.0)
		{
		}

		public RefractionCoefficient(double refCoef) : base(refCoef)
		{
		}
