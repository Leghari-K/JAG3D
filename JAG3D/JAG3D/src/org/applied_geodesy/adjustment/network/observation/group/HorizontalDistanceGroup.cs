...
namespace org.applied_geodesy.adjustment.network.observation.group
{
	...
	public class HorizontalDistanceGroup : ObservationGroup
	{
...
//JAVA TO C# CONVERTER NOTE: Field name conflicts with a method name of the current type:
		...
		public HorizontalDistanceGroup(int id) : base(id, DefaultUncertainty.UncertaintyDistanceZeroPointOffset, DefaultUncertainty.UncertaintyDistanceSquareRootDistanceDependent, DefaultUncertainty.UncertaintyDistanceDistanceDependent, Epoch.REFERENCE)
		{
		}

		public HorizontalDistanceGroup(int id, double sigmaA, double sigmaB, double sigmaC, Epoch epoch) : base(id, sigmaA, sigmaB, sigmaC, epoch)
		{
		}

		public override void add(Observation distance2d)
		{
