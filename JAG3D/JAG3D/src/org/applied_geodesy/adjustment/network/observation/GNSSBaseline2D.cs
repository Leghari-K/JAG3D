...
namespace org.applied_geodesy.adjustment.network.observation
{
	...
	public abstract class GNSSBaseline2D : GNSSBaseline
	{

		public GNSSBaseline2D(int id, Point startPoint, Point endPoint, double observation, double sigma) : base(id, startPoint, endPoint, 0, 0, observation, sigma)
		{
		}
