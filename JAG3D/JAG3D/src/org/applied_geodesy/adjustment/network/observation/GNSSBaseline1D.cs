...
namespace org.applied_geodesy.adjustment.network.observation
{
	...
	public abstract class GNSSBaseline1D : GNSSBaseline3D
	{

		public GNSSBaseline1D(int id, Point startPoint, Point endPoint, double observation, double sigma) : base(id, startPoint, endPoint, observation, sigma)
		{
		}
