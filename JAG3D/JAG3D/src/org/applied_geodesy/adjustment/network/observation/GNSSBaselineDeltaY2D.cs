...
namespace org.applied_geodesy.adjustment.network.observation
{
	...
	public class GNSSBaselineDeltaY2D : GNSSBaseline2D
	{

		public GNSSBaselineDeltaY2D(int id, Point startPoint, Point endPoint, double observation, double sigma) : base(id, startPoint, endPoint, observation, sigma)
		{
		}
