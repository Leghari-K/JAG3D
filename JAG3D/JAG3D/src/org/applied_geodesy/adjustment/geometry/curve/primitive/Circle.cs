...
//ORIGINAL LINE: public void setInitialGuess(double x0, double y0, double r) throws IllegalArgumentException
		public virtual void setInitialGuess(double x0, double y0, double r)
		{
		...
		{
			return "$\\vert \\mathbf{P}_i - \\mathbf{P}_0 \\vert = r" + " \\\\ " + "\\mathbf{P}_0 = \\left( \\begin{array}{c} x_0 \\\\ y_0 \\end{array} \\right)$";
		}
	}
