...
namespace org.applied_geodesy.juniform.test
{
	...
	public class CircleTest : NISTTest
	{
		private CircleTest()
		{
		}
	...
	//		1 number represents the diameter of the circle
			...
			double[] references = new double[] {x0Ref, y0Ref, rRef};

			IList<ParameterType> types = new List<ParameterType> {ParameterType.ORIGIN_COORDINATE_X, ParameterType.ORIGIN_COORDINATE_Y, ParameterType.RADIUS};
