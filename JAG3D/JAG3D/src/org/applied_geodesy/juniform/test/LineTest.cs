...
namespace org.applied_geodesy.juniform.test
{
	...
	public class LineTest : NISTTest
	{
		private LineTest()
		{
		}
	...
	//		3 numbers represent the direction cosines of the line
			...
			double nxRef = referenceResults[idxX + 3];
			double nyRef = referenceResults[idxY + 3];
			...
			double[] references = new double[] {x0Ref, y0Ref, nxRef, nyRef};

			IList<ParameterType> types = new List<ParameterType> {ParameterType.ORIGIN_COORDINATE_X, ParameterType.ORIGIN_COORDINATE_Y, ParameterType.VECTOR_X, ParameterType.VECTOR_Y};
