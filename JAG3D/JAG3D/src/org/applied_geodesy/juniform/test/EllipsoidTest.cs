...
namespace org.applied_geodesy.juniform.test
{
	...
	public class EllipsoidTest : NISTTest
	{
	...
	//		1 number represents the diameter of the sphere
			...
			double[] references = new double[] {x0Ref, y0Ref, z0Ref, 1.0 / rRef, 1.0 / rRef, 1.0 / rRef};

			IList<ParameterType> types = new List<ParameterType> {ParameterType.ORIGIN_COORDINATE_X, ParameterType.ORIGIN_COORDINATE_Y, ParameterType.ORIGIN_COORDINATE_Z, ParameterType.MAJOR_AXIS_COEFFICIENT, ParameterType.MIDDLE_AXIS_COEFFICIENT, ParameterType.MINOR_AXIS_COEFFICIENT};
