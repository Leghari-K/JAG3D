...
namespace org.applied_geodesy.juniform.test
{
	...
	public class CircularCylinderTest : NISTTest
	{
	...
	//		1 number represents the diameter of the cylinder
			...
			double[] references = new double[] {x0Ref, y0Ref, z0Ref, nxRef, nyRef, nzRef, rRef};

			IList<ParameterType> types = new List<ParameterType> {ParameterType.ORIGIN_COORDINATE_X, ParameterType.ORIGIN_COORDINATE_Y, ParameterType.ORIGIN_COORDINATE_Z, ParameterType.VECTOR_X, ParameterType.VECTOR_Y, ParameterType.VECTOR_Z, ParameterType.RADIUS};
