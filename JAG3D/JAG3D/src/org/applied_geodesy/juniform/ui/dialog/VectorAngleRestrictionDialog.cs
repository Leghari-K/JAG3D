...
namespace org.applied_geodesy.juniform.ui.dialog
{
	...
	public class VectorAngleRestrictionDialog
	{
		...
		{
			private readonly VectorAngleRestrictionDialog outerInstance;

			public RegressorEventHandler(VectorAngleRestrictionDialog outerInstance)
			{
		...
		public static Optional<VectorAngleRestriction> showAndWait(ObservableList<UnknownParameter> unknownParameters, VectorAngleRestriction VectorAngleRestriction)
		{
			...
			restrictionTypeDialog.Restriction = VectorAngleRestriction;
		...
		private class CallbackAnonymousInnerClass : Callback<ButtonType, VectorAngleRestriction>
		{
			private readonly VectorAngleRestrictionDialog outerInstance;

			public CallbackAnonymousInnerClass(VectorAngleRestrictionDialog outerInstance)
			{
				this.outerInstance = outerInstance;
			}

			public override VectorAngleRestriction call(ButtonType buttonType)
			{
		...
		private class ChangeListenerAnonymousInnerClass : ChangeListener<Number>
		{
			...
			public ChangeListenerAnonymousInnerClass(VectorAngleRestrictionDialog outerInstance)
			{
				this.outerInstance = outerInstance;
			}
		...
		private class ChangeListenerAnonymousInnerClass2 : ChangeListener<Number>
		{
			...
			public ChangeListenerAnonymousInnerClass2(VectorAngleRestrictionDialog outerInstance)
			{
				this.outerInstance = outerInstance;
			}
