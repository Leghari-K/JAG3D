...
namespace org.applied_geodesy.juniform.ui.tree
{
	...
	public class AdjustmentTreeItemValue : TreeItemValue<FeatureAdjustment>
	{

		internal AdjustmentTreeItemValue(string name) : base(name, TreeItemType.ADJUSTMENT)
		{
			this.Object = new FeatureAdjustment();
		}
