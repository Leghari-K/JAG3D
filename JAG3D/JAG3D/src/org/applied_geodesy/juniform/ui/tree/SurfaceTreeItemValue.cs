...
namespace org.applied_geodesy.juniform.ui.tree
{
	...
	public class SurfaceTreeItemValue : TreeItemValue<Surface>
	{
		internal SurfaceTreeItemValue(string name, TreeItemType treeItemType) : base(name, treeItemType)
		{
		}
		...
		public override TabType[] TabTypes
		{
			get
			{
				return new TabType[] {TabType.POINT_SELECTION, TabType.APOSTERIORI_PARAMETER};
			}
		}
	}
