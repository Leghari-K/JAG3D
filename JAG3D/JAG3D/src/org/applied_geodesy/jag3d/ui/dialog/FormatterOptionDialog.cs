...
namespace org.applied_geodesy.jag3d.ui.dialog
{
	...
	public class FormatterOptionDialog
	{
		...
		private TitledPane createFormatterOptionValuesPane()
		{
			...
			this.addRow(i18n.getString("FormatterOptionDialog.unit.scale.value.label", "Scale:"), i18n.getString("FormatterOptionDialog.unit.scale.value.tooltip.digits", "Set number of fraction digits for type scale"), i18n.getString("FormatterOptionDialog.unit.scale.value.tooltip.unit", "Set unit for type scale value"), formatterOptions[CellValueType.SCALE], gridPane, ++row);
		...
		private TitledPane createFormatterOptionUncertaintiesPane()
		{
			...
			this.addRow(i18n.getString("FormatterOptionDialog.unit.scale.uncertainty.label", "Scale uncertainty:"), i18n.getString("FormatterOptionDialog.unit.scale.uncertainty.tooltip.digits", "Set number of fraction digits for type scale uncertainty"), i18n.getString("FormatterOptionDialog.unit.scale.uncertainty.tooltip.unit", "Set unit for type scale uncertainty"), formatterOptions[CellValueType.SCALE_UNCERTAINTY], gridPane, ++row);
...
//ORIGINAL LINE: java.util.Collection<? extends org.applied_geodesy.util.unit.Unit> angleUnits = new java.util.LinkedHashSet<org.applied_geodesy.util.unit.AngleUnit>(org.applied_geodesy.util.unit.AngleUnit.UNITS.values());
		...
		private void save(FormatterOptions.FormatterOption option)
		{
			try
			{
				SQLManager.Instance.saveFormatterOption(option);
			}
			catch (Exception e)
			{
				Platform.runLater(() =>
				{
				OptionDialog.showThrowableDialog(i18n.getString("FormatterOptionDialog.message.error.save.exception.title", "Unexpected SQL-Error"), i18n.getString("FormatterOptionDialog.message.error.save.exception.header", "Error, could not save formatter properties to database."), i18n.getString("FormatterOptionDialog.message.error.save.exception.message", "An exception has occurred during database transaction."), e);
				});
			}
		}
	}
