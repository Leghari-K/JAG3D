...
namespace org.applied_geodesy.jag3d.ui.table
{
	...
	public class UITestStatisticTableBuilder : UITableBuilder<TestStatisticRow>
	{

		private static UITestStatisticTableBuilder tableBuilder = new UITestStatisticTableBuilder();
		private bool isInitialize = false;
		private UITestStatisticTableBuilder() : base()
		{
		}

		public static UITestStatisticTableBuilder Instance
		{
			get
			{
				tableBuilder.init();
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			doubleColumn = this.getColumn<double>(header, TestStatisticRow::numeratorDegreeOfFreedomProperty, getDoubleCallback(cellValueTypeStatistic), ColumnType.VISIBLE, columnIndex, false);
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			doubleColumn = this.getColumn<double>(header, TestStatisticRow::denominatorDegreeOfFreedomProperty, getDoubleCallback(cellValueTypeStatistic), ColumnType.VISIBLE, columnIndex, false);
			table.getColumns().add(doubleColumn);
			...
			header = new ColumnTooltipHeader(cellValueTypePercent, labelText, tooltipText, options.FormatterOptions[cellValueTypePercent].getUnit());
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			doubleColumn = this.getColumn<double>(header, TestStatisticRow::probabilityValueProperty, getDoubleCallback(cellValueTypePercent), ColumnType.VISIBLE, columnIndex, false);
			table.getColumns().add(doubleColumn);
			...
			header = new ColumnTooltipHeader(cellValueTypePercent, labelText, tooltipText, options.FormatterOptions[cellValueTypePercent].getUnit());
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			doubleColumn = this.getColumn<double>(header, TestStatisticRow::powerOfTestProperty, getDoubleCallback(cellValueTypePercent), ColumnType.VISIBLE, columnIndex, false);
			table.getColumns().add(doubleColumn);
			...
			header = new ColumnTooltipHeader(cellValueTypeStatistic, labelText, tooltipText);
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			doubleColumn = this.getColumn<double>(header, TestStatisticRow::noncentralityParameterProperty, getDoubleCallback(cellValueTypeStatistic), ColumnType.VISIBLE, columnIndex, false);
			table.getColumns().add(doubleColumn);
			...
			header = new ColumnTooltipHeader(cellValueTypeStatistic, labelText, tooltipText);
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			doubleColumn = this.getColumn<double>(header, TestStatisticRow::pValueProperty, getDoubleCallback(cellValueTypeStatistic), ColumnType.VISIBLE, columnIndex, false);
			table.getColumns().add(doubleColumn);
			...
			header = new ColumnTooltipHeader(cellValueTypeStatistic, labelText, tooltipText);
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			doubleColumn = this.getColumn<double>(header, TestStatisticRow::quantileProperty, getDoubleCallback(cellValueTypeStatistic), ColumnType.VISIBLE, columnIndex, false);
			table.getColumns().add(doubleColumn);
		...
		internal override void setValue(TestStatisticRow row, int columnIndex, object oldValue, object newValue)
		{
		}
		public override TestStatisticRow EmptyRow
		{
			get
			{
