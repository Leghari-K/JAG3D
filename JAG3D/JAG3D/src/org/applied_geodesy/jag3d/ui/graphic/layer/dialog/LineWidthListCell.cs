...
namespace org.applied_geodesy.jag3d.ui.graphic.layer.dialog
{
	...
	public class LineWidthListCell : ListCell<double>
	{

		private NumberFormat numberFormat;
		internal LineWidthListCell()
		{
		...
		protected internal virtual void updateItem(double? lineWidth, bool empty)
		{
			base.updateItem(lineWidth, empty);
